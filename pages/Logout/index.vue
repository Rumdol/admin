...
<div class="w-[1000px] h-[500px] shadow border-b-blue-200 flex flex-col justify-center items-center">
  <h1 class="text-3xl">Are you sure to Log Out your account?</h1>
  <div class="icon">
    <img src="@/assets/image/logout-icon.png" alt="logout icon">
  </div>
  <button class="bg-primary p-1 rounded text-lg hover:bg-opacity-50 active:bg-opacity-100" @click="confirmLogout">Logout</button>
</div>
</template>
